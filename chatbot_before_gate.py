...
print("\n===================================")
print(" Emotion-Aware RAG Chatbot Ready ")
...
- Avoid direct advice whenever possible.
- Avoid phrases like:
  "You should"
  "You need to"
  "You must"
...
while True:
    ...
    try:
        print("Top Emotion:", emo["top_emotions"][0]["label"])
        print("Score      :", round(
            emo["top_emotions"][0]["score"], 3
        ))
    except Exception:
        pass
    ...
    system += (
        "\n\nRelevant Emotional Support Examples:\n"
        + context
    )
